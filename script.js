...
const AppData = {
    courses: [
        ...
        },
        {
            ...
            description: 'A comprehensive 10-level logical thinking assessment designed to evaluate problem-solving abilities. This mandatory prerequisite course mimics the 1337 École de Code entry exam format.',
            ...
            isMandatory: true,
            lessons: [
                'Level 1: Pattern Recognition Basics',
                'Level 2: Memory & Attention',
                'Level 3: Basic Logic Puzzles',
                'Level 4: Advanced Patterns',
                'Level 5: Spatial Reasoning',
                'Level 6: Complex Logic',
                'Level 7: Algorithm Thinking',
                'Level 8: Abstract Reasoning',
                'Level 9: Advanced Problem Solving',
...
const UI = {
    ...
    enrollInCourse: (courseId) => {
        try {
            ...
            Utils.showNotification('Successfully enrolled! Redirecting to your dashboard...', 'success');
            ...
            if (error.message.includes('log in')) {
                ...
                Utils.showNotification('Please log in to enroll in courses', 'info');
                setTimeout(() => {
                    UI.showModal('loginModal');
                }, 500);
            } else {
